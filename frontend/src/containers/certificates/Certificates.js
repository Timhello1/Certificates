    ...
    render() {
        ...
        return (<div>
                ...
                >
                    ...
                    <TableHeaderColumn width="35" dataField='description'>Description</TableHeaderColumn>
                    <TableHeaderColumn width="35" dataField='user_id'>User</TableHeaderColumn>
                    <TableHeaderColumn width="20" dataField='id' dataFormat={(cell, row) => {
                        return <div>
                            ...
                            <LinkContainer to={`/certificates`} onClick={() => this.delete2(row.id)}>
                                <OverlayTrigger placement="top" overlay={
                                    <Tooltip id="tooltip">
                                        Delete
                                    </Tooltip>
